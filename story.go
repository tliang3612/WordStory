...
// Define ServeHTTP function for handler
func (h handler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Print("Error connecting to path")

}

// return Story struct given Json file
func DecodeJsonToStruct(r io.Reader) (Story, error) {
...
func UnmarshalJsonToStruct(jsonStr string) (Story, error) {

	//return the json encoding of jsonStr
	byteValue, err := json.Marshal(jsonStr)
	if err != nil {
		return nil, err
	}
	...
	//Better for if data is already in memory, and not reading from stream
	if err = json.Unmarshal(byteValue, &story); err != nil {
		return nil, err
	}
